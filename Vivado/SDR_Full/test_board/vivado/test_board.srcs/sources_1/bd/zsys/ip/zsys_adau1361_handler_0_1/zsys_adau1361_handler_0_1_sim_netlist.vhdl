...
architecture STRUCTURE of zsys_adau1361_handler_0_1_adau1361_handler is
  ...
  signal o_dacData8_out : STD_LOGIC;
  ...
  signal o_dacData_reg_i_3_n_0 : STD_LOGIC;
  signal o_dacData_reg_i_4_n_0 : STD_LOGIC;
  signal o_dacData_reg_i_5_n_0 : STD_LOGIC;
  signal o_dacData_reg_i_6_n_0 : STD_LOGIC;
  signal o_dacData_reg_i_7_n_0 : STD_LOGIC;
  signal o_dacData_reg_i_8_n_0 : STD_LOGIC;
  ...
  signal o_error_i_5_n_0 : STD_LOGIC;
  signal o_error_i_6_n_0 : STD_LOGIC;
  ...
  signal r_dividerCounter : STD_LOGIC_VECTOR ( 5 to 5 );
  ...
  attribute SOFT_HLUTNM of o_bclk_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of o_error_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of o_error_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of o_error_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of o_error_i_6 : label is "soft_lutpair1";
  attribute X_INTERFACE_INFO of o_left_adc_valid_reg : label is "xilinx.com:interface:axis:1.0 M_AXIS_LEFT_ADC TVALID";
  attribute SOFT_HLUTNM of o_lrclk_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of o_lrclk_i_3 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of o_lrclk_i_4 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \r_bitCounter[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \r_bitCounter[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_bitCounter[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_bitCounter[4]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_dacData[31]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_dividerCounter[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \r_dividerCounter[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_dividerCounter[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \r_dividerCounter[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \r_dividerCounter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of r_started_i_1 : label is "soft_lutpair2";
begin
  ...
  o_lrclk <= \^o_lrclk\;
  o_mclk <= \^o_mclk\;
\oS_left_adc_data[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      I0 => \oS_left_adc_data[15]_i_2_n_0\,
      I1 => w_bclk,
      I2 => r_started,
      I3 => i_resetn,
      O => \oS_left_adc_data[15]_i_1_n_0\
    );
\oS_left_adc_data[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
o_dacData_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^o_dacdata\,
      I1 => o_dacData8_out,
      I2 => o_dacData_reg_i_3_n_0,
      I3 => \r_bitCounter_reg_n_0_[4]\,
      I4 => o_dacData_reg_i_4_n_0,
      I5 => r_dividerCounter(5),
      O => o_dacData_i_1_n_0
    );
o_dacData_i_10: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[6]\,
      I1 => \r_dacData_reg_n_0_[4]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[5]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
      I5 => \r_dacData_reg_n_0_[3]\,
      O => o_dacData_i_10_n_0
    );
o_dacData_i_11: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => \r_dacData_reg_n_0_[10]\,
      I1 => \r_dacData_reg_n_0_[8]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[9]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
      I5 => \r_dacData_reg_n_0_[7]\,
      O => o_dacData_i_11_n_0
    );
o_dacData_i_12: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
      I0 => \r_dacData_reg_n_0_[14]\,
      I1 => \r_dacData_reg_n_0_[12]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[13]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_i_13: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[18]\,
      I1 => \r_dacData_reg_n_0_[16]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[17]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_i_14: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[22]\,
      I1 => \r_dacData_reg_n_0_[20]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[21]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_i_15: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[26]\,
      I1 => \r_dacData_reg_n_0_[24]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[25]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_i_16: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[30]\,
      I1 => \r_dacData_reg_n_0_[28]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[29]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_i_9: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
        ...
        port map (
      I0 => \r_dacData_reg_n_0_[2]\,
      I1 => \r_dacData_reg_n_0_[0]\,
      I2 => \r_bitCounter_reg_n_0_[0]\,
      I3 => \r_dacData_reg_n_0_[1]\,
      I4 => \r_bitCounter_reg_n_0_[1]\,
...
o_dacData_reg_i_3: unisim.vcomponents.MUXF8
     port map (
      I0 => o_dacData_reg_i_5_n_0,
      I1 => o_dacData_reg_i_6_n_0,
      O => o_dacData_reg_i_3_n_0,
      S => \r_bitCounter_reg_n_0_[3]\
    );
o_dacData_reg_i_4: unisim.vcomponents.MUXF8
     port map (
      I0 => o_dacData_reg_i_7_n_0,
      I1 => o_dacData_reg_i_8_n_0,
      O => o_dacData_reg_i_4_n_0,
      S => \r_bitCounter_reg_n_0_[3]\
    );
o_dacData_reg_i_5: unisim.vcomponents.MUXF7
     port map (
      I0 => o_dacData_i_9_n_0,
      I1 => o_dacData_i_10_n_0,
      O => o_dacData_reg_i_5_n_0,
      S => \r_bitCounter_reg_n_0_[2]\
    );
o_dacData_reg_i_6: unisim.vcomponents.MUXF7
     port map (
      I0 => o_dacData_i_11_n_0,
      I1 => o_dacData_i_12_n_0,
      O => o_dacData_reg_i_6_n_0,
      S => \r_bitCounter_reg_n_0_[2]\
    );
o_dacData_reg_i_7: unisim.vcomponents.MUXF7
     port map (
      I0 => o_dacData_i_13_n_0,
      I1 => o_dacData_i_14_n_0,
      O => o_dacData_reg_i_7_n_0,
      S => \r_bitCounter_reg_n_0_[2]\
    );
o_dacData_reg_i_8: unisim.vcomponents.MUXF7
     port map (
      I0 => o_dacData_i_15_n_0,
      I1 => o_dacData_i_16_n_0,
      O => o_dacData_reg_i_8_n_0,
      S => \r_bitCounter_reg_n_0_[2]\
    );
o_error_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FBF8000000000000"
    )
        port map (
      I0 => o_error_i_2_n_0,
      I1 => o_error_i_3_n_0,
...
o_error_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10000000"
    )
        port map (
...
o_error_i_5: unisim.vcomponents.LUT6
    generic map(
...
o_error_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
o_left_adc_valid_i_1: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => i_left_dac_valid,
      I2 => i_resetn,
      O => r_dividerCounter(5)
    );
o_left_adc_valid_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
o_lrclk_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\r_bitCounter[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\r_bitCounter[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9F99"
    )
        port map (
...
\r_dacData[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\r_dividerCounter[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
        ...
        port map (
      I0 => \r_dividerCounter_reg_n_0_[4]\,
      I1 => w_mclk,
      I2 => \r_dividerCounter_reg_n_0_[0]\,
      I3 => \r_dividerCounter_reg_n_0_[1]\,
      I4 => \r_dividerCounter_reg_n_0_[3]\,
      O => p_1_in(4)
    );
\r_dividerCounter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
        ...
        port map (
      I0 => w_bclk,
      I1 => \r_dividerCounter_reg_n_0_[3]\,
      I2 => \r_dividerCounter_reg_n_0_[1]\,
      I3 => \r_dividerCounter_reg_n_0_[0]\,
      I4 => w_mclk,
      I5 => \r_dividerCounter_reg_n_0_[4]\,
      O => p_1_in(5)
    );
